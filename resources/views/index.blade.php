...
<html lang="en">
    <head>        
        ...
        <!-- CSS INCLUDE -->        
        <link rel="stylesheet" type="text/css" id="theme" href="{{URL::asset('css/theme-dark.css')}}"/>
        <!-- EOF CSS INCLUDE -->                                    
    </head>
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">HMS</div>
                                <div class="profile-data-title">Welcome to HMS</div>
                            </div>
                    ...
                    <li class="active">
                        <a href="/main"><span class="fa fa-desktop"></span> <span class="xn-text">Home</span></a>                        
                    </li>
                    <li class="active">
                        <a href="/add"><span class="fa fa-book"></span> <span class="xn-text">Add Hotels</span></a>                        
                    </li> 
                    <li class="active">
                        <a href="/search"><span class="fa fa-search"></span> <span class="xn-text">Search Hotels</span></a>                        
                    </li> 
                    <li class="active">
                        <a href="/update"><span class="fa fa-eye"></span> <span class="xn-text">View Hotels</span></a>                        
                    </li>    
                </ul>
                <!-- END X-NAVIGATION -->
            </div>
